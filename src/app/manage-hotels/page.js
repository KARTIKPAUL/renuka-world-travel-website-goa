...
export default function ManageHotelsPage() {
  ...
  const filteredHotels = hotels.filter((hotel) => {
    const matchesSearch =
      ...
      hotel.location.state.toLowerCase().includes(searchTerm.toLowerCase());
    const matchesHotelType =
      !filterHotelType || hotel.hotelType === filterHotelType;
    const matchesStarRating =
      !filterStarRating || hotel.starRating.toString() === filterStarRating;

    return matchesSearch && matchesHotelType && matchesStarRating;
  });
      ...
      <div className="p-4">
        ...
        <div className="space-y-2 mb-4 text-xs text-gray-600">
          <div className="flex items-center justify-between">
            <span className="capitalize bg-indigo-100 text-indigo-800 px-2 py-1 rounded">
              {hotel.hotelType}
            </span>
          ...
          {hotel.totalRooms && (
            <div className="flex items-center gap-1">
              ...
              <span>
                {hotel.availableRooms || 0}/{hotel.totalRooms} rooms available
              </span>
            </div>
          )}
        ...
        {hotel.roomTypes && hotel.roomTypes.length > 0 && (
          <div className="mb-4 text-sm">
            <div className="font-semibold text-gray-900">
              From ₹{Math.min(...hotel.roomTypes.map((rt) => rt.price))} / night
            </div>
        ...
        <div className="flex gap-2">
          <button
            onClick={() => router.push(`/edit-hotel/${hotel._id}`)}
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="mt-2 text-gray-600">
              Manage all your hotel listings from here
            </p>
          </div>
